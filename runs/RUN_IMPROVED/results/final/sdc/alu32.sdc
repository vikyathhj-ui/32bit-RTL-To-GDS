...
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {opcode[2]}]
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {opcode[3]}]
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {opcode[4]}]
...
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {negative}]
